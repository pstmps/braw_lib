...
#define SWIGTYPE_p_std__allocatorT_std__pairT_std__string_const_std__string_t_t swig_types[7]
...
/*-----------------------------------------------
              @(target):= _bmd_metadata.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__bmd_metadata

#else
#  define SWIG_init    init_bmd_metadata

#endif
#define SWIG_name    "_bmd_metadata"
...
SWIGINTERN PyObject *_wrap_read_metadata(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), "in method '" "read_metadata" "', argument " "1"" of type '" "std::string const""'"); 
    }
    arg1 = *ptr;
